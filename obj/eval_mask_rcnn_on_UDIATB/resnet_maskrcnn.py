...
def get_pretrained_resnet101(pretrained, state_dict_path):
...
def get_pretrained_resnet50(pretrained, state_dict_path):
    ...
    return model
def get_pretrained_wide_resnet50_2(pretrained, state_dict_path):
